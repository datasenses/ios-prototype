...
#ifndef DATASENSES_IOS_SWIFT_H
#define DATASENSES_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Datasenses_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("DatasensesObjCWrapper")
@interface Datasenses : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Datasenses * _Nonnull shared;)
+ (Datasenses * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
- (void)registerPushNotificationWithToken:(NSString * _Nullable)token apnToken:(NSString * _Nullable)apnToken;
- (void)flushWithCompletion:(void (^ _Nullable)(void))completion;
- (void)resetWithCompletion:(void (^ _Nullable)(void))completion;
- (void)trackEventWithName:(NSString * _Nonnull)event properties:(NSDictionary<NSString *, id> * _Nullable)properties;
